...
<body>
    ...
    <div class="address-bar">3481 Melrose Street | Cannaught Place, Delhi | 123.456.7890</div>
	  ...
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<p>If you want to try coconut oil in your cup of joe, start small by 
        adding 1 tablespoon (14 grams) to hot coffee and stirring it thoroughly to ensure that the oil incorporates well. 
        Some people prefer to blend the oil with coffee in a blender to make a delicious tropical-style beverage.</p>
		  </div>
	...
	<div id="myModal2" class="modal fade" role="dialog">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<p>Irish coffee is a cocktail consisting of hot coffee, Irish whiskey, and sugar, stirred, and topped with cream. 
        The coffee is drunk through the cream.The small amount of alcohol in Irish coffee isn't even going to give you a buzz, 
        but it will improve your mood.If you drink Irish coffee with a double shot of whiskey then it might just give you a buzz, 
        partly due to the alcohol being hot/warm.</p>
		  </div>
		  <div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		  </div>
	...
	<div id="myModal3" class="modal fade" role="dialog">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<p>This frothy, blended espresso drink will wake you up and make you happy any time of day. Sweetened with caramel 
        sauce and topped with whipped cream, this is one delicious frozen latte.</p>
		  </div>
		  <div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		  </div>
